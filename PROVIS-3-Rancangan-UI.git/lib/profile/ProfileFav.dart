...
class ProfileFavPage extends StatefulWidget {
  const ProfileFavPage({Key? key}) : super(key: key);

  @override
  State<ProfileFavPage> createState() => _ProfileFavPageState();
}

class _ProfileFavPageState extends State<ProfileFavPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildFavoriteRecipeGrid() {
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: GridView.count(
        ...
        children: [
          ...
          _buildRecipeCard(
            'Fruit Crepes',
            'Fluffy filled chocolate crepes',
          ...
          _buildRecipeCard(
            'Quinoa Salad',
            'Nutritious ingredients tossed in salad',
